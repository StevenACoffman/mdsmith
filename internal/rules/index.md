...
| [MDS039](MDS039-build/README.md)                              | `build`                              | ready     | Validate `<?build?>` directive parameters and keep the section body in sync with the recipe's rendered `body_template`. |
